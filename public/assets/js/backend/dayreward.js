define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dayreward/index' + location.search,
                    add_url: 'dayreward/add',
                    edit_url: 'dayreward/edit',
                    del_url: 'dayreward/del',
                    multi_url: 'dayreward/multi',
                    import_url: 'dayreward/import',
                    table: 'day_reward',
                }
            });
