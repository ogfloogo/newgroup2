...
{
    //代付提单url(提现)
    public $dai_url = 'https://interface.wowpayglobal.com/pay/transfer';
    //代收提交url(充值)
    public $pay_url = 'https://interface.wowpayglobal.com/pay/web';
    //代付回调(提现)
    public $notify_dai = 'https://api.wegrouping.com/pay/wowpay/paydainotify';
    //代收回调(充值)
    public $notify_pay = 'https://api.wegrouping.com/pay/wowpay/paynotify';
    //支付成功跳转地址    
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://gx83ixk6srer.wowhescqct.com/pay/web"); //支付请求地址
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://gx83ixk6srer.wowhescqct.com/pay/transfer"); //支付请求地址
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
        curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, false);
        curl_setopt($ch, CURLOPT_POST, true);
        curl_setopt($ch, CURLOPT_HEADER, false);
