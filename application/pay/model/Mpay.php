...
class Mpay extends Model
{
    ...
    //代付回调(提现)
    public $notify_dai = 'https://api.wegrouping.com/pay/mpay/paydainotify';
    //代收回调(充值)
    public $notify_pay = 'https://api.wegrouping.com/pay/mpay/paynotify';
    //代收秘钥
    ...
    public function paydainotify($params)
    {
        ...
        $check = $this->sendSign($params, $this->key);
        if ($sign != $check) {
            Log::mylog('验签失败', $params, 'Mpaydfhd');
            return false;
        }
