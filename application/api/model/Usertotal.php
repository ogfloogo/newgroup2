...
class Usertotal extends Model
{
    ...
    {
        return $date ? 'newgroup:bit:' . $date : 'newgroup:bit:' . date('ymd');
    }

    public function getAgentUserListKey($agent_id)
    {
        return $agent_id ? 'newgroup:user:bit:' . $agent_id : 'newgroup:user:bit:0';
    }

    public function getAgentUserLoginKey($agent_id)
    {
        return $agent_id ? 'newgroup:login:bit:' . $agent_id : 'newgroup:login:bit:0';
    }
